...
- **Installation Steps:**
  1. ENSURE YOUR COPY OF GH2 IS IN A RAW-FILE FORMAT (Refer to the picture below) ![dependencies/STOCK GH2 360 FOLDER.png](dependencies/STOCK GH2 360 FOLDER.png)
  2. Take your GH2 Raw Files and Place them within `Guitar-Hero-II-Deluxe-Unified\platform\xbox` (it should look like the picture below, DO NOT DELETE ANYTHING ALREADY IN THE FOLDER) ![dependencies/360 STEP 2.png](dependencies/360 STEP 2.png)
